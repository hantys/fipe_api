...
module FipeApi
  ...
  class Table < FipeApi::Base
    ...
    def self.all(vehicle)
      ...
      tables = []
      response = HTTP.post('https://veiculos.fipe.org.br/api/veiculos/ConsultarTabelaDeReferencia', headers: HEADERS, body: {}.to_json).to_s
    ...
    def self.latest(vehicle)
      return nil if vehicle.nil? || !vehicle.is_a?(FipeApi::Vehicle)
